...
import { BusinessCenter, Schedule, LocationOn, AdminPanelSettings } from "@mui/icons-material"
      ...
      <Container maxWidth="lg">
        <Box sx={{ pt: 8, pb: 6, textAlign: "center" }}>
          ...
          <Typography variant="h5" color="text.secondary" sx={{ mb: 4, maxWidth: "600px", mx: "auto" }}>
            Streamline your service bookings with dynamic pricing, location management, and comprehensive end-to-end
            flows.
          </Typography>
